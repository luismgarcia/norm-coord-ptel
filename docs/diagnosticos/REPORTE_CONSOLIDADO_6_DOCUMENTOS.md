...
### Fase 1 (Esta semana) - 4 horas
- [1] Parser ODT mejorado (2-3h) → Mayor impacto
- [2] Validación Y >= 4M (30min)
- [3] Detección coords concatenadas (30min)

### Fase 2 (Próxima semana) - 4 horas
- [4] Integración hidrogrqfía DERA (2h)
- [5] Integración red viaria DERA (2h)

### Fase 3 (Cuando sea posible) - 2 horas
- [6-9] Validaciones menores (1.5h)
- Documentación y tests (30min)
